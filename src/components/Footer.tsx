...
export default function Footer() {
	...
	return (
		<footer className="bg-gradient-to-b from-sky-400 to-sky-500 text-white px-6 md:px-16 lg:px-24 py-10">
			<div className="flex flex-col items-center md:flex-row justify-between gap-10 flex-wrap">
				...
				<div className="flex flex-col gap-1 min-w-[180px]">
					...
					<p className="text-sm text-white">+57 3245837514</p>
					<p className="text-sm text-white">+57 3245837514</p>
					<p className="text-sm text-white">+57 3245837514</p>
				</div>
				...
				<div className="flex flex-col gap-1 min-w-[180px]">
					...
					<p className="text-sm text-white">Cartagena, Colombia</p>
					<p className="text-sm text-white">
						Mamonal, Provincia de Cartagena, Bolívar
					</p>
				</div>
