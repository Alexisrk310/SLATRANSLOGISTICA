...
export const metadata: Metadata = {
	...
	description: `Nuestra empresa se especializa en ofrecer soluciones integrales de transporte de carga terrestre garantizando puntualidad, seguridad y eficiencia en cada servicio.`,
	icons: {
